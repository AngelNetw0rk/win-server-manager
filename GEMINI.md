...
* **Версионирование и Git:** При коммите всегда инкрементируй номер версии в файле `VERSION` **И обновляй бейдж версии в `README.md`**. После коммита всегда делай `git push`.
